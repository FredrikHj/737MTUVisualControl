/*!
 * Phidget22 JavaScript Library (Network Client) v3.16.1 (https://phidgets.com)
 *  phidget22 release 1.16.20230706
...
const C_LIBRARY_VERSION = "1.16";
/**
 * The base Phidget22 library version for this release - corresponds to the C library version
 * @public
 */

const LibraryVersion = "Phidget22 - Version " + C_LIBRARY_VERSION + " - Built July 6, 2023";
/**
 * The JavaScript library version
 * @public
 */

const JSLibraryVersion = "3.16.1 - July 6, 2023";
const Managers = [];
const Connections = [];
const UserPhidgets = [];
let Epoch;
